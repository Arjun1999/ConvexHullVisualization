...
plt.plot
plt.savefig("/home/arjun/Desktop/Semester_7/CompGeo/ConvexHullVisualization/StepsOutput/"+str(count)+'.jpg')
plt.clf()
...
for i in range(count):
    new_frame = Image.open("/home/arjun/Desktop/Semester_7/CompGeo/ConvexHullVisualization/StepsOutput/" + str(i) + ".jpg")
