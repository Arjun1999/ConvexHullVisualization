...
plt.scatter(x, y)
plt.plot
plt.savefig("/home/arjun/Desktop/Semester_7/CompGeo/ConvexHullVisualization/StepsOutputGraphInput/"+str(count)+'.jpg')
plt.clf()
...
for i in range(count):
    new_frame = Image.open("/home/arjun/Desktop/Semester_7/CompGeo/ConvexHullVisualization/StepsOutputGraphInput/" + str(i) + ".jpg")
    image_frames.append(new_frame)

image_frames[0].save("ConvexHullVisualizationProcess.gif", format='GIF',append_images=image_frames[1:], save_all=True, duration=400, loop=0)

im = Image.open("/home/arjun/Desktop/Semester_7/CompGeo/ConvexHullVisualization/ConvexHullVisualizationProcess.gif")

# for frame in ImageSequence.Iterator(im):
#     im = Image.open("ConvexHullVisualizationProcess.gif")
...
plt.scatter(datapoints_angles[:, 0], datapoints_angles[:, 1])
plt.plot(convex_hull[:, 0], convex_hull[:, 1], c='g')
plt.savefig("/home/arjun/Desktop/Semester_7/CompGeo/ConvexHullVisualization/FinalOutput" + '.jpg')
plt.clf()
