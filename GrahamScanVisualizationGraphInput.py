...
plt.scatter(x, y)
plt.plot
plt.savefig("/home/arjun/Desktop/Semester_7/CompGeo/IMT2017008_Project/StepsOutputGraphInput/"+str(count)+'.jpg')
plt.clf()
...
for i in range(count):
    new_frame = Image.open("/home/arjun/Desktop/Semester_7/CompGeo/IMT2017008_Project/StepsOutputGraphInput/" + str(i) + ".jpg")
...
im = Image.open("/home/arjun/Desktop/Semester_7/CompGeo/IMT2017008_Project/ConvexHullVisualizationProcess.gif")
...
plt.scatter(datapoints_angles[:, 0], datapoints_angles[:, 1])
plt.plot(convex_hull[:, 0], convex_hull[:, 1], c='g')
plt.savefig("/home/arjun/Desktop/Semester_7/CompGeo/IMT2017008_Project/FinalOutput" + '.jpg')
plt.clf()
